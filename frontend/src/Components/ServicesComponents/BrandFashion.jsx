  ...
  return (
    <>
      <div className="flex justify-center items-center w-full h-auto md:h-[640px] mt-32 mx-auto px-4 md:px-0">
        <div className="flex flex-col-reverse md:flex-row justify-center items-stretch gap-12 w-full max-w-[945.23px] mx-auto">
          {/* Left Div */}
          <div className="flex flex-col justify-center w-full md:w-[480.23px] h-full px-4 md:px-0">
            <div className="flex flex-col justify-center h-full"> {/* Add this wrapper div */}
              <h2 className="mt-4 font-bold text-2xl">Brand Fashion</h2>
              <p>
