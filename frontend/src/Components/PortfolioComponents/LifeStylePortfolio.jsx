...
const LifeStylePortfolio = () => {
  ...
  useEffect(() => {
    const fetchVideos = async () => {
      try {
        const response = await axios.get("/api/services/name/Lifestyle Fashion");
...
export default LifeStylePortfolio;
...
//   useEffect(() => {
//     // Fetching the video data from the API
//     const fetchVideos = async () => {
//       try {
//         const response = await axios.get("http://localhost:5000/api/services/name/lifestyle");
//         const fetchedVideos = response.data.categories[0].videos.map(video => video.url);
//         setVideos(fetchedVideos);
//       } catch (error) {
//         console.error("Error fetching video data", error);
...
//     // "https://avidbucket.s3.amazonaws.com/video/1731308788814_istock-1290744826.mov",
